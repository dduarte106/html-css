...
<head>
	...
	<meta name="description"
		content="Mobilidade urbana para estruturação do sistema cicloviário no bairro Parque Mambucaba, em Angra dos Reis.">
	<meta name="author" content="Prefeitura de Angra dos Reis">
	<meta name="keywords"
		content="Angra dos Reis, Parque Mambucaba, Ciclovia, Projeto cicloviário, Mobilidade Urbana, Perequê, Bicicletas">
...
<body>
	...
	<nav class="navbar navbar-expand-lg position-fixed w-100 navbar-scroll">
		<div class="container">
			...
			<button class="navbar-toggler hamburger-button" id="btn-hamburguer" type="button" data-bs-toggle="collapse"
				data-bs-target="#navbarText">
				<i id="menu-icon" class="bi bi-list custon-icons"></i> <!-- Ícone do menu hamburguer -->
				<i id="close-icon" class="bi bi-x custon-icons" style="display: none;"></i>
				<!-- Ícone "X" (oculto por padrão) -->
			</button>
			<div class="navbar-collapse d-flex justify-content-end" id="navbarText">
				<ul class="navbar-nav container-nav-bar">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="" id="bibliotecaDropdown" role="button"
	...
	<div class="container my-5 py-5">
		<div class="row-12 d-flex justify-content-center align-items-center contact" id="contact">
			<div class="col-12 col-md-8 col-lg-6 col-xl-3  infos-form m-5">
				<div class="row">
					...
					<div class="mb-3 col-12">
						<label for="exampleFormControlInput3" class="form-label">Telefone/Whatsapp:</label>
						<input type="telefone" class="form-control" id="exampleFormControlInput3"
							placeholder="name@example.com">
					</div>
				</div>
				
			</div>
			<div class="col-12 col-md-8 col-lg-6 col-xl-3 infos-opn m-5">
				<div class="mb-3">
					<label for="exampleFormControlTextarea1" class="form-label">Example textarea</label>
					<textarea class="form-control-txt" id="exampleFormControlTextarea1" rows="3"></textarea>
				</div>
			</div>
		</div>
	</div>
        ...
        <div class="container bottom_border">
            <div class="row" style="display: flex; justify-content: space-between;">
                <div class=" col-sm-6 col-md-6 col-sm-6  col-12 col">
                    ...
                    <p><span class="material-symbols-outlined">pin_drop</span> <a href="https://maps.app.goo.gl/WkviiWpUzwAu5yeE8" target="_blank"> Rua Historiador Alípio Mendes, 156, antigo Fórum, Centro</a>  </p>
                    <p><span class="material-symbols-outlined">call</span> <a href="tel:+552433771755" target="_blank"> (24) 3377-1755</a>  </p>
                    <p><span class="material-symbols-outlined">mail</span> <a href="mailto:ssp.mobilidade@angra.rj.gov.br" target="_blank"> ssp.mobilidade@angra.rj.gov.br</a> </p>
